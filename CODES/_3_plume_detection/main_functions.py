...
from ..shared_utils import (align_bathymetry_to_resolution, 
...
from .utils import (reduce_resolution, create_polygon_mask, preprocess_annual_dataset_and_compute_land_mask)
...
def apply_plume_mask(core_arguments, Zones, detect_plumes_on_which_temporal_resolution_data,
    ...
    for i, info in cases_to_process.iterrows() : 
        ...
        with multiprocessing.Pool(nb_of_cores_to_use) as pool:
            ...
            results = pool.starmap(module_utils.main_process, 
                        [(    file_name, 
                              file_names_pattern, 
                              parameters,
